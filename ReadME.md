The published google chrome extension that I made for this project can be found at: [HERE](https://chrome.google.com/webstore/detail/random-websites/ionmnimhlhpjggfanmohgipbefpdmaoa).
